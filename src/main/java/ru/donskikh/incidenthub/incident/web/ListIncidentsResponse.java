...
public record ListIncidentsResponse(
        @Schema(description = "Incidents on the requested page", example = "[]") List<IncidentListItemResponse> items,
        @Schema(description = "Zero-based page index", example = "0") int page,
        @Schema(description = "Actual page size", example = "20") int size,
        @Schema(description = "Total number of matching incidents", example = "12") long totalElements,
